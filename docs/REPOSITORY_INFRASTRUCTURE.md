...
| Package | Additional `require` | `suggest` |
|---|---|---|
| `core` | (none) | — |
| `tensor` | `ferry-ai/inference-core: ^0.1.0` | — |
| `onnx-backend` | `ferry-ai/inference-core: ^0.1.0`, `ankane/onnxruntime: ^0.3.0` | `ext-ffi` |
| `llama-backend` | `ferry-ai/inference-core: ^0.1.0` | `ext-ffi` |
| `cpu-backend` | `ferry-ai/inference-core: ^0.1.0` | `rubix/ml` |
| `tokenizer` | `ferry-ai/inference-core: ^0.1.0` | `ext-ffi` |
| `embedding` | `ferry-ai/inference-core: ^0.1.0` | `ferry-ai/inference-onnx-backend`, `ferry-ai/inference-tokenizer` |
| `pipeline` | `ferry-ai/inference-core: ^0.1.0` | `ferry-ai/inference-embedding`, `ferry-ai/inference-tokenizer`, `ferry-ai/inference-vector` |
| `model-hub` | `ferry-ai/inference-core: ^0.1.0`, `ext-hash: *`, `ext-zip: *` | `ext-sodium`, `ext-curl` |
| `vector` | `ferry-ai/inference-core: ^0.1.0`, `ext-pdo: *` | `ext-pdo_sqlite`, `ext-pdo_pgsql`, `ext-ffi`, `ext-sqlite3` |
| `dataframe` | `ferry-ai/inference-core: ^0.1.0`, `ferry-ai/inference-tensor: ^0.1.0` | — |
| `ai` | `ferry-ai/inference-core: ^0.1.0`, `ferry-ai/inference-onnx-backend: ^0.1.0`, `ferry-ai/inference-llama-backend: ^0.1.0`, `ferry-ai/inference-cpu-backend: ^0.1.0`, `ferry-ai/inference-tokenizer: ^0.1.0`, `ferry-ai/inference-embedding: ^0.1.0`, `ferry-ai/inference-pipeline: ^0.1.0`, `ferry-ai/inference-model-hub: ^0.1.0`, `ferry-ai/inference-vector: ^0.1.0`, `psr/http-factory: ^1.0`, `psr/http-message: ^1.1 \|\| ^2.0` | `nyholm/psr7`, `guzzlehttp/psr7` |
| `laravel` | `ferry-ai/inference-ai: ^0.1.0` | `laravel/framework`, `illuminate/support` |
| `symfony` | `ferry-ai/inference-ai: ^0.1.0` | `symfony/http-kernel`, `symfony/config`, `symfony/dependency-injection` |

> Framework adapters (`laravel`, `symfony`) declare their framework packages as **`suggest`**, not
> `require` — the adapters are intentionally decoupled and depend only on `ferry-ai/inference-ai`
> (see the "no hard framework coupling" architecture rule). The ONNX runtime uses `ankane/onnxruntime`;
> model-hub ships a native `HuggingFaceClient` and has no third-party Hugging Face dependency.
